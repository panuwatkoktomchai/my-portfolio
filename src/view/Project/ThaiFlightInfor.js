	...
	<div className="w3-container w3-text-white w3-margin me-font">
		...
		<div className="project-item">
			<div className="w3-margin-left">
				<h2 className="me-font">Thai Flight Information </h2>
				<p className="me-text me-tab-space">Department of Airports. Maintenance website[CMS] Service of mobile and Database.</p>
			</div>
			...
			<table className="w3-table w3-black-transparent w3-hoverable">
				<tbody className="w3-margin">
					...
					<tr>
						<td> <b>Service</b> </td>
						<td>
						<span className="w3-tag w3-blue"> <a target="__blank" href="https://laravel.com/">Laravel Framework 5.2 </a> </span>
						</td>
						<td> Provide flight information such as Flight radar, Flight schedule and other</td>
					</tr>
					<tr>
						<td></td>
						<td>
							<span className="w3-tag w3-blue w3-margin-right"> 
								<a target="__blank" href="https://nodejs.org/en/">Nodejs</a>
							</span>
							<span className="w3-tag w3-blue">
								<a target="__blank" href="https://socket.io/">Socket.io</a>
							</span>
						</td>
						<td> Provide real-time flight information for mobile application</td>
					</tr>
					<tr>
						<td><b>Database</b></td>
						<td>
